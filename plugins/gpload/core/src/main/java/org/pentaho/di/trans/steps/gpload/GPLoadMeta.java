...
public class GPLoadMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public void setDefault() {
    ...
    gploadPath = "/usr/local/greenplum-db-clients/bin/gpload";
    controlFile = "${GPLOAD_CFG}/${Internal.Transformation.Name}.cfg";
    dataFile = "${GPLOAD_DAT}/${Internal.Transformation.Name}.dat";
    logFile = "${GPLOAD_LOG}/${Internal.Transformation.Name}.log";
    nullAs = "\\N";
    encoding = "UTF8";
    preSQL = "";
    postSQL = "";
